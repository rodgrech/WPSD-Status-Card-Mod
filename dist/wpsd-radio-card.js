  ...
  renderMcs2000() {
    ...
    return `
      <style>
        ...
        .mcs-knob{width:34px;height:34px;border-radius:50%;background:radial-gradient(circle at 38% 32%,#ffd31f 0 8px,transparent 9px),radial-gradient(circle,#4a4e50 0 38%,#1d2022 40% 67%,#070707 69%);border:2px solid #060606;box-shadow:inset 0 2px 4px rgba(255,255,255,.2)}
        .mcs-port{width:30px;height:24px;border-radius:5px;background:#050606;border:3px solid #313539;box-shadow:inset 0 0 0 3px #111;transform:translateY(5px)}
      ...
      <div class="mcs-radio ${this._mcsInverted ? "invert" : ""}"><div class="mcs-face">
        <div class="mcs-left"><div class="mcs-leds"><span class="mcs-led rx" title="RX indicator"></span><span class="mcs-led tx" title="TX indicator"></span></div><div class="mcs-knob"></div><span class="mcs-pill">Zone</span><span class="mcs-port" title="Microphone socket"></span><span class="mcs-pill">Page</span><span></span><span class="mcs-pill mcs-opt" title="Invert LCD">Opt</span></div>
