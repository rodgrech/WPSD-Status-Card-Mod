  ...
  renderMcs2000() {
    ...
    return `
      <style>
        ...
        .mcs-center{min-width:0;display:grid;grid-template-rows:15px 66px 21px;row-gap:4px}.mcs-brand-strip{display:flex;align-items:center;justify-content:space-between;height:15px;padding:0 5px;color:#cdd4d7;font-size:9px;font-weight:800;line-height:1}
        ...
        .mcs-lcd-area{display:grid;grid-template-columns:10px 1fr 10px;gap:4px;align-items:center}.mcs-arrow{width:0;height:0;border-top:8px solid transparent;border-bottom:8px solid transparent}.mcs-arrow.left{border-right:7px solid #d8d8d8;justify-self:end}.mcs-arrow.right{border-left:7px solid #d8d8d8}
      ...
      <div class="mcs-radio ${this._mcsInverted ? "invert" : ""}"><div class="mcs-face">
        <div class="mcs-left"><div class="mcs-leds"><span class="mcs-led rx"></span><span class="mcs-led tx"></span></div><div class="mcs-knob"></div><span class="mcs-pill">Zone</span><span class="mcs-port" title="Microphone socket"></span><span class="mcs-pill">Page</span><span></span><span class="mcs-pill mcs-opt" title="Invert LCD">Opt</span></div>
